...
{
    return isset($_SESSION['idVisiteur']);//isset c'est une fonction qui retourne un bool si y a qqch dans la variable SESSION (tab) dans la collonne id visiteur
}
...
{
    return isset($_SESSION['idComptable']);//isset c'est une fonction qui retourne un bool si y a qqch dans la variable SESSION (tab) dans la collonne id comptable
}
...
function getLesDouzesDerniersMois($mois) {
